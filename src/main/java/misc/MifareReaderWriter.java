...
//    static {
//        terminal.setCardTerminal(CardTerminalUtils.getTerminalByName("ACS ACR122 0"));
//    }
    private static final MfReaderWriter readerWriter = new Acr122ReaderWriter(terminal);

    private static final byte[] KEY_A_VALUE = hexStringToByteArray("ffffffffffff");
    private static final byte[] KEY_B_VALUE = hexStringToByteArray("000000000001");
    
    private static final String DATA_STRING = "00000000000000000000000000000001";
